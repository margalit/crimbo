import { View, Text, AspectRatio, Button, Link } from "reshaped";
  ...
  return (
    <View gap={6} paddingTop={4}>
      ...
      <View gap={1}>
        ...
        <Text variant="body-1">
          Photos of trees are called ‘harvests’. Players receive more points
          later in the year as trees get rarer making it possible to win with
          just a few late harvests.
        </Text>
      </View>
      <View gap={1}>
      ...
      <View gap={1}>
        ...
        <Text variant="body-1">
          Absolutely! <Link onClick={() => void onSignIn()}>Sign in</Link> with
          your Google account and start harvesting.
        </Text>
      </View>
    </View>
  );
